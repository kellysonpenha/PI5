        ...
        <div class="col-md-6">
          <div class="box box-dark">
            ...
            <div class="box-body">
              ...
              <form>
                <div class="col-md-12">
                  <h4>Dados de acesso <i class="fa fa-fw fa-question-circle" data-toggle="tooltip" data-placement="top" title="Deseja atualizar o endereço de e-mail?"></i></h4>
                </div>
                <div class="form-group col-md-6">
                  <label>E-mail atual</label>
                  <input type="email" name="" class="form-control" placeholder="Digite seu e-mail" required="" data-toggle="popover" data-trigger="focus" data-placement="right" data-content="Deseja atualizar o endereço de e-mail?">
                </div>
                <div class="form-group col-md-6">
